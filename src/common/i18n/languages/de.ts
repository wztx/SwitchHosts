...
const lang: LanguageDict = {
  ...
  days: 'Tage',
  delete: 'Löschen',
  dns_custom_url: 'Benutzerdefinierte DoH-URL-Vorlage',
  dns_custom_url_desc:
    'Muss den Platzhalter {domain} enthalten, z. B. https://doh.example.com/resolve?name={domain}&type=A',
  dns_custom_url_invalid: 'Die Vorlage muss den Platzhalter {domain} enthalten.',
  dns_provider: 'DNS-Resolver für Domänen',
  dns_provider_custom: 'Benutzerdefiniert',
  dns_provider_desc:
    'DNS-over-HTTPS-Dienst zur Auflösung von Remote-Hosts-Einträgen vom Typ „Domäne".',
  domain_hint:
    'Wird über {0} zu einer IP aufgelöst und als Hosts-Eintrag geschrieben. Der DNS-Dienst kann in den Einstellungen geändert werden.',
  ...
  invalid_domain: '„{0}" ist kein gültiger Domänenname.',
