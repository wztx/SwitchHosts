...
export default {
  ...
  days: 'days',
  delete: 'Delete',
  dns_custom_url: 'Custom DoH URL template',
  dns_custom_url_desc:
    'Must contain the {domain} placeholder, e.g. https://doh.example.com/resolve?name={domain}&type=A',
  dns_custom_url_invalid: 'The template must contain the {domain} placeholder.',
  dns_provider: 'Domain DNS resolver',
  dns_provider_custom: 'Custom',
  dns_provider_desc: 'DNS-over-HTTPS service used to resolve domain-type remote hosts entries.',
  domain_hint:
